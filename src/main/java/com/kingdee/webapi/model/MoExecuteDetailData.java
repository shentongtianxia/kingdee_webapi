 ...
 * 生产订单执行明细表数据映射
 */
@ApiModel(description = "生产订单执行明细表数据", value = "MoExecuteDetailData")
public class MoExecuteDetailData {

    @ApiModelProperty(value = "生产车间")
    private String FWORKSHOPID;

    @ApiModelProperty(value = "单据类型")
    private String FMOBILLTYPEID;
    ...
    @ApiModelProperty(value = "汇报数量")
    private String FREPORTQTY;

    @ApiModelProperty(value = "请检数量")
    private String FAPPINSPECTQTY;
    ...
    private String FSTOCKINQUAQTY;

    @ApiModelProperty(value = "不合格品入库数量")
    private String FSTOCKINFAILQTY;

    @ApiModelProperty(value = "报废品入库数量")
    private String FStockInScrapQty;

    @ApiModelProperty(value = "返工品入库数量")
    private String FSTOCKINREMADEQTY;

    @ApiModelProperty(value = "退库数量")
    private String FReStkQty;
    ...
    public String getFWORKSHOPID() { return FWORKSHOPID; }
    public void setFWORKSHOPID(String FWORKSHOPID) { this.FWORKSHOPID = FWORKSHOPID; }

    public String getFMOBILLTYPEID() { return FMOBILLTYPEID; }
    public void setFMOBILLTYPEID(String FMOBILLTYPEID) { this.FMOBILLTYPEID = FMOBILLTYPEID; }

    public String getFMOBILLNO() { return FMOBILLNO; }
    public void setFMOBILLNO(String FMOBILLNO) { this.FMOBILLNO = FMOBILLNO; }

    public String getFMOENTRYSEQ() { return FMOENTRYSEQ; }
    public void setFMOENTRYSEQ(String FMOENTRYSEQ) { this.FMOENTRYSEQ = FMOENTRYSEQ; }
    ...
    public String getFSTARTDATE() { return FSTARTDATE; }
    public void setFSTARTDATE(String FSTARTDATE) { this.FSTARTDATE = FSTARTDATE; }
    ...
    public String getFREPORTQTY() { return FREPORTQTY; }
    public void setFREPORTQTY(String FREPORTQTY) { this.FREPORTQTY = FREPORTQTY; }

    public String getFAPPINSPECTQTY() { return FAPPINSPECTQTY; }
    public void setFAPPINSPECTQTY(String FAPPINSPECTQTY) { this.FAPPINSPECTQTY = FAPPINSPECTQTY; }

    public String getFINSPECTQTY() { return FINSPECTQTY; }
    public void setFINSPECTQTY(String FINSPECTQTY) { this.FINSPECTQTY = FINSPECTQTY; }

    public String getFFINISHQTY() { return FFINISHQTY; }
    public void setFFINISHQTY(String FFINISHQTY) { this.FFINISHQTY = FFINISHQTY; }

    public String getFSTOCKINQUAQTY() { return FSTOCKINQUAQTY; }
    public void setFSTOCKINQUAQTY(String FSTOCKINQUAQTY) { this.FSTOCKINQUAQTY = FSTOCKINQUAQTY; }

    public String getFSTOCKINFAILQTY() { return FSTOCKINFAILQTY; }
    public void setFSTOCKINFAILQTY(String FSTOCKINFAILQTY) { this.FSTOCKINFAILQTY = FSTOCKINFAILQTY; }

    public String getFStockInScrapQty() { return FStockInScrapQty; }
    public void setFStockInScrapQty(String FStockInScrapQty) { this.FStockInScrapQty = FStockInScrapQty; }

    public String getFSTOCKINREMADEQTY() { return FSTOCKINREMADEQTY; }
    public void setFSTOCKINREMADEQTY(String FSTOCKINREMADEQTY) { this.FSTOCKINREMADEQTY = FSTOCKINREMADEQTY; }

    public String getFReStkQty() { return FReStkQty; }
    public void setFReStkQty(String FReStkQty) { this.FReStkQty = FReStkQty; }
    ...
    public String getFQUAPERCENT() { return FQUAPERCENT; }
    public void setFQUAPERCENT(String FQUAPERCENT) { this.FQUAPERCENT = FQUAPERCENT; }
